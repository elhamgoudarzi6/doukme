...
export class AuthComponent implements OnInit {
  ...
  sendSMS() {
    this.display = true;
    this.service.getTokenSms().subscribe((tokenRes: { IsSuccessful: boolean; TokenKey: any; }) => {
      if (tokenRes.IsSuccessful === true) {
        ...
        this.service.sendSms(data, token).subscribe((smsRes: { IsSuccessful: boolean; }) => {
  ...
  redirectToPanel() {
    this.display = false;
    this.service.authUser(this.form.value).subscribe((result: { success: boolean; data: any; }) => {
